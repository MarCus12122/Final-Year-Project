...
public class ChatActivity extends AppCompatActivity
{
    ...
    private ImageButton SendImageFileButton, SendMessagButton;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        SendMessagButton.setOnClickListener(new View.OnClickListener()
        {
            @Override
    ...
    private void InitializeFields()
    {
        ...
        SendMessagButton = (ImageButton)findViewById(R.id.send_message_button);
