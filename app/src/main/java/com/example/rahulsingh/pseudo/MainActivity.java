...
public class MainActivity extends AppCompatActivity
{
    ...
    private DatabaseReference UsersRef, PostsRef, LikesRef, TestRef;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        TestRef = FirebaseDatabase.getInstance().getReference().child("Users").child(currentUserID);
   ...
   @Override
    ...
    {
        final String current_user_id = "profileimage";
